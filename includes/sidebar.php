...
<div class="sidebar fixed h-full bg-red-800 text-white w-64 z-10" id="sidebar">
    ...
    <nav class="mt-4">
        <ul>
            <li class="mb-1">
                <a href="/pdv-seu-coxinha/vendas/index.php" class="nav-item flex items-center p-3 hover:bg-red-700 <?php echo ($activePage == 'vendas') ? 'active-nav' : ''; ?>">
                    <i class="fas fa-cash-register text-yellow-400 mr-3"></i>
                    <span class="nav-text">Vendas</span>
                </a>
            </li>
            <li class="mb-1">
                <a href="/pdv-seu-coxinha/estoque/index.php" class="nav-item flex items-center p-3 hover:bg-red-700 <?php echo ($activePage == 'estoque') ? 'active-nav' : ''; ?>">
                    <i class="fas fa-boxes text-yellow-400 mr-3"></i>
                    <span class="nav-text">Estoque</span>
                </a>
            </li>
            <li class="mb-1">
                <a href="/pdv-seu-coxinha/produtos/index.php" class="nav-item flex items-center p-3 hover:bg-red-700 <?php echo ($activePage == 'produtos') ? 'active-nav' : ''; ?>">
                    <i class="fas fa-hamburger text-yellow-400 mr-3"></i>
                    <span class="nav-text">Produtos</span>
                </a>
            </li>
            <li class="mb-1">
                <a href="/pdv-seu-coxinha/funcionarios/index.php" class="nav-item flex items-center p-3 hover:bg-red-700 <?php echo ($activePage == 'funcionarios') ? 'active-nav' : ''; ?>">
